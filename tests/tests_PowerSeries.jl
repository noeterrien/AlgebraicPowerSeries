...
@test getNum(multidim_sin_ps[1,1][1,0,0,0]) ≈ 1
@test getNum(multidim_sin_ps[1,1][3,0,0,0]) ≈ -1/6
@test getNum(multidim_sin_ps[2,1][3,3,0,0]) ≈ -1/6
@test getNum(multidim_sin_ps[2,2][3,3,3,3]) ≈ -1/6
