...
$$\begin{cases}
  K_{xx}(x,y) - K_{yy}(x,y) = \frac{\lambda(y)+c}{\eps}K(x,y) \\
  K(x,0) = 0 \\
...
$$\begin{cases}
  \gamma_t = \Sigma(x) \gamma_x + C_0(x) \gamma\\
  \alpha(0,t) = q\beta(0,t) \\
  \beta(1,t) = 0
\end{cases}$$

where $\gamma = \left[\alpha, \beta\right]^T$ and $C_0(x) = \begin{pmatrix} c_1(x) & 0 \\ 0 & c_4(x) \end{pmatrix}$
...
\begin{align*}
  \Sigma(x)K_x(x,y) + K_y(x,y)\Sigma(y) &= K(x,y)\left[C(y)-\Sigma'(y)\right]-C_0(x)K(x,y) \\
...
\begin{align}
  \epsilon_1(x)K^{uu}_x + \epsilon_1(y)K^{uu}_y &= -\left[c_1(y)+\epsilon_1'(y)-c_1(x)\right]K^{uu} - c_3(y)K^{uv} \\
  \epsilon_1(x)K^{uv}_x -\epsilon_2(y)K^{uv}_y &= \left[\epsilon_2'(y)-c_4(y)+c_1(x)\right]K^{uv} -c_2(y)K^{uu} \\
  \epsilon_2(x)K^{vu}_x - \varepsilon_1(y)K^{vu}_y &= \left[c_1(y) + \epsilon_1'(y)-c_4(x)\right]K^{vu} + c_3(y)K^{vv} \\
  \epsilon_2(x)K^{vv}_x + \epsilon_2(y)K^{vv}_y &= \left[c_4(y)-\epsilon_2'(y)-c_4(x)\right]K^{vv}+ c_2(y)K^{vu}
\end{align}
...
\begin{align*}
  \Sigma(x) &= \begin{pmatrix}
    ...
    0 & \epsilon_2(x)
  \end{pmatrix} = \begin{pmatrix}
    -\sum_{i=0}^{+\infty} \epsilon^1_ix^i & 0 \\
    0 & \sum_{i=0}^{+\infty} \epsilon^2_ix^i
  \end{pmatrix} \text{ where } \epsilon^1_0, \epsilon^2_0 > 0 \\
  C(x) &= \begin{pmatrix}
    c_1(x) & c_2(x) \\
    c_3(x) & c_4(x)
  \end{pmatrix} \text{\hspace{0.6em}} = \begin{pmatrix}
    \sum_{i=0}^{+\infty} c^1_ix^i & \sum_{i=0}^{+\infty} c^2_ix^i \\
    \sum_{i=0}^{+\infty} c^3_ix^i & \sum_{i=0}^{+\infty} c^4_ix^i
  \end{pmatrix}
\end{align*}
...
\begin{align*}
  ...
  &\text{\hspace{1em}} 
  +\doubleSum{\sum_{k=0}^{i-j}K^{uu}_{(k+j)j}c^1_{i-j-k}} - 
  \doubleSum{\sum_{k=0}^{j}K^{uu}_{(i-j+k)k}c^1_{j-k}}
\end{align*}
...
\begin{align*}
  ...
  &\text{\hspace{1em}}
  + \sum_{k=0}^{i-j}K^{uu}_{(k+j)j}c^1_{i-j-k}
  - \sum_{k=0}^{j}K^{uu}_{(i-j+k)k}c^1_{j-k}
\end{align*}
...
\fbox{\parbox{\textwidth}{\begin{align*}
  ...
  &\text{\hspace{1em}}
  + \sum_{k=0}^{i-1-j}K^{uu}_{(k+j)j}c^1_{i-1-j-k}
  - \sum_{k=0}^{j}K^{uu}_{(i-1-j+k)k}c^1_{j-k}
\end{align*}}}
...
\begin{align*}
  ...
  &\text{\hspace{1em}}
  + \sum_{k=0}^{i-1-j}K^{uv}_{(k+j)j}c^1_{i-1-j-k}
  - \sum_{k=0}^{j}K^{uv}_{(i-1-j+k)k}c^4_{j-k}
\end{align*}
}}
...
\begin{align*}
  ...
  &\text{\hspace{1em}}
  - \sum_{k=0}^{i-1-j}K^{vu}_{(k+j)j}c^4_{i-1-j-k}
  + \sum_{k=0}^{j}K^{vu}_{(i-1-j+k)k}c^1_{j-k}
\end{align*}
}}
...
\begin{align*}
  ...
  &\text{\hspace{1em}}
  - \sum_{k=0}^{i-1-j}K^{vv}_{(k+j)j}c^4_{i-1-j-k}
  + \sum_{k=0}^{j}K^{vv}_{(i-1-j+k)k}c^4_{j-k}
\end{align*}
}}
