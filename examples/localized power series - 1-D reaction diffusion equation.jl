...
begin
	ax1 = Axis(fig[1,1]; title="K(1,y) for different values of N with K centered at (0,0)", xlabel="y")
	ax2 = Axis(fig[2,1]; title="K(1,y) for different values of N with K centered at (1,0)", xlabel="y")
	ax3 = Axis(fig[3,1]; title="K(1,y) for different values of N with K centered at (1,1)", xlabel="y")
end
